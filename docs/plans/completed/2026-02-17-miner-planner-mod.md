...
- [x] Write README.md with mod description, features, usage instructions, screenshots placeholders
- [x] Add changelog.txt with initial version entry
- [x] Update info.json description field
