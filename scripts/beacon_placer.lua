...
--- @param beacon_module_quality string|nil Quality for beacon modules
...
function beacon_placer.place(surface, force, player, drill_positions, drill_info,
                             ...
                             beacon_module_quality, max_beacons_per_drill, gap, polite)
    ...
    local function try_place_beacon(cand)
        ...
        if was_placed then
            ...
            if ghost and ghost.valid and beacon_module_name and beacon_module_name ~= "" then
                ...
                local mod_quality = beacon_module_quality or quality
                local insert_plan = {}
